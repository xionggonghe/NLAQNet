...
for file in os.listdir(norm_dir):
    ...
    if (
        ...
        module = importlib.import_module("model.ViTlayers.normalization." + model_name)
...
from model.ViTlayers.normalization.batch_norm import BatchNorm2d, BatchNorm1d, BatchNorm3d
from model.ViTlayers.normalization.group_norm import GroupNorm
from model.ViTlayers.normalization.instance_norm import InstanceNorm1d, InstanceNorm2d
from model.ViTlayers.normalization.sync_batch_norm import SyncBatchNorm
from model.ViTlayers.normalization.layer_norm import LayerNorm, LayerNorm2D
