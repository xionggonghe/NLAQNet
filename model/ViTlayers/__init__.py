...
def layer_specific_args(parser: argparse.ArgumentParser):
    ...
    for file in os.listdir(layer_dir):
        ...
        if (
            ...
            module = importlib.import_module("model.ViTlayers." + layer_name)
...
def arguments_nn_layers(parser: argparse.ArgumentParser):
    ...
    from model.ViTlayers.activation import arguments_activation_fn

    parser = arguments_activation_fn(parser)

    from model.ViTlayers.normalization import arguments_norm_layers
